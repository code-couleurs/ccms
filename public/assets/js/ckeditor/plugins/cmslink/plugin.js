    ...
    return {
        ...
        },
        {
            ...
            [
            {
                ...
                commit : function( data )
		{
                    data.pagebox_title = this.getValue();
		}
            }
            ]
        }
        ...
        onOk : function()
        {
            ...
            switch(global_dialog.definition.dialog._.currentTabId)
            {
                ...
                case 'to_file' :
                    ...
                    break;              
                case 'to_pagebox' :
                    link.setAttribute( 'href', '{pagebox_create}');
                    link.setAttribute( 'class', 'fancy_link');
                    link.setHtml(data.pagebox_title);
                    break;
