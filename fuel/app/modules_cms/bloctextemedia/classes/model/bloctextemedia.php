...
class Model_BlocTexteMedia extends \Orm\Model
{
        protected static $_table_name = 'blocs_texte_media';
	...
	protected static $_properties = array(
        ...
        public function save($cascade = null, $use_transaction = false, $revision_id = null)
        {
            if(empty($this->id) && !is_null($revision_id))
            {
                ...
                $this->bloc->code = 'bloc_texte_media';
            }
        ...
        {
            $new = Model_BlocTexteMedia::forge();
